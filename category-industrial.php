<?php
/**
 * Category Template for Industry, Manufacturing & Transportation)
 *
 */
		...
		<main id="main" class="site-main" role="main">
			<section id="cta-bar">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<a href="#mc-form-header">Learn more about our Industrial programs<span class="fa fa-arrow-circle-down" style="font-family:FontAwesome; margin-left:30px;"></span></a>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="row">
					<div class="col-xs-12 rm-padding">
						<div class='coa-program-list'>
							<h3>COA Industry, Manufacturing & Transportation Programs</h3>
							<div class="container">
							<div class="row">
								<?php if ( have_posts() ) : ?>
						...
						<div id="hs-form" class="mc-form career-form">
							...
							<div id="mc_embed_signup">
								...
								<?php if( function_exists( 'ninja_forms_display_form' ) ){ ninja_forms_display_form( 319 ); }; ?> 
