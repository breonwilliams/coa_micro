		...
		<main id="main" class="site-main" role="main">
			<section id="cta-bar">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<a href="#mc-form-header">Learn more about our Business & Computer programs<span class="fa fa-arrow-circle-down" style="font-family:FontAwesome; margin-left:30px;"></span></a>
						</div>
					</div>
				</div>
			</section>
				        ...
				        <span class='toggle'>Careers</span>
				       	<div class='toggle-content'>
							<ul>
								...
								<?php $args = array(
										'category_name'=>'business-computers',
										'orderby' => 'date',
										'order'   => 'ASC'
									);

									$businessMenu = new WP_Query( $args );

									while ( $businessMenu->have_posts() ) : $businessMenu->the_post();
			...
			<div class="career-wrap">
				...
				<?php $args = array(
					...
					$businessPosts = new WP_Query( $args );

					while ( $businessPosts->have_posts() ) : $businessPosts->the_post();
				...
				<div class="row">
					<div class="col-xs-12 rm-padding">
						<div class='coa-program-list'>
							<h3>COA Business & Computer Programs</h3>
							<div class="container">
							<div class="row">
								<?php if ( have_posts() ) : ?>
							       	...
							       	<div class='toggle-content'>
											...
											<ul>
												<?php $args = array(
													...
													$businessDegrees = new WP_Query( $args );

													while ( $businessDegrees->have_posts() ) : $businessDegrees->the_post();
							       	...
							       	<div class='toggle-content'>
											...
											<ul>
												...
												<?php $args = array(
													...
													$businessCertificates = new WP_Query( $args );

													while ( $businessCertificates->have_posts() ) : $businessCertificates->the_post();
						...
						<div id="hs-form" class="mc-form career-form">
							...
							<div id="mc_embed_signup">
								...
								<?php if( function_exists( 'ninja_forms_display_form' ) ){ ninja_forms_display_form( 315 ); }; ?> 
