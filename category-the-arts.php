<?php
/**
 * Category Template for The Arts
 *
 */
		...
		<main id="main" class="site-main" role="main">
			<section id="cta-bar">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<a href="#mc-form-header">Learn more about our Arts programs<span class="fa fa-arrow-circle-down" style="font-family:FontAwesome; margin-left:30px;"></span></a>
						</div>
					</div>
				</div>
			</section>
				       	...
				       	<div class='toggle-content it-menu'>
							<ul>
								...
								<?php $args = array(
									...
									$artsMenu = new WP_Query( $args );

									while ( $artsMenu->have_posts() ) : $artsMenu->the_post();
					...
					<div class="col-xs-12 rm-padding">
							       	...
							       	<div class='toggle-content'>
											...
											<ul>
												...
												<?php $args = array(
													...
													$artsDegrees = new WP_Query( $args );

													while ( $artsDegrees->have_posts() ) : $artsDegrees->the_post();
							       	...
							       	<div class='toggle-content'>
											...
											<ul>
												...
												<?php $args = array(
													...
													$artsDimplomas = new WP_Query( $args );

													while ( $artsDimplomas->have_posts() ) : $artsDimplomas->the_post();
						...
						<div id="hs-form" class="mc-form career-form">
							...
							<div id="mc_embed_signup">
								...
								<?php if( function_exists( 'ninja_forms_display_form' ) ){ ninja_forms_display_form( 320 ); }; ?> 
