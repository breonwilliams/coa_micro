<?php
/**
 * Category Template for Hospitality & Public Services
 *
 */
		...
		<main id="main" class="site-main" role="main">
			<section id="cta-bar">
				<div class="container">
					<div class="row">
						<div class="col-xs-12">
							<a href="#mc-form-header">Learn more about our Hospitality & Public Services programs<span class="fa fa-arrow-circle-down" style="font-family:FontAwesome; margin-left:30px;"></span></a>
						</div>
					</div>
				</div>
			</section>
				        ...
				        <span class='toggle'>Careers</span>
				       	<div class='toggle-content hs-menu'>
							<ul>
								...
								<?php $args = array(
										'category_name'=>'hospitality-public-services',
										'orderby' => 'date',
										'order'   => 'ASC'
									);
				...
				<div class="row">
					<div class="col-xs-12 rm-padding">
						<div class='coa-program-list'>
							<h3>COA Hospitality & Public Services Programs</h3>
							<div class="container">
							<div class="row">
								<?php if ( have_posts() ) : ?>
						...
						<div id="hs-form" class="mc-form career-form">
							...
							<div id="mc_embed_signup">
								...
								<?php if( function_exists( 'ninja_forms_display_form' ) ){ ninja_forms_display_form( 317 ); }; ?> 
